...
labels_disci = "./synthetic_data_labels/test_data_labels/test_disp/test-disp-label-95-99.txt"
labels_inter = "./synthetic_data_labels/test_data_labels/test_interdisp/test-inter-disp-label-95-99.txt"
trainfile = open("./test_data/test_data_99.txt", "w")
